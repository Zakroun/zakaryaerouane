...
import { Sun, Download, Mail, Phone, MapPin, ExternalLink } from "lucide-react";
        ...
        >
            <div className="fixed inset-0 z-0 overflow-hidden">
                <div className="absolute inset-0">
                    ...
                    <div
                        className={`absolute inset-0 opacity-4 ${isDark
                            ? "bg-[linear-gradient(90deg,#1d1d1d_1px,transparent_1px),linear-gradient(#1d1d1d_1px,transparent_1px)]"
                    ...
                    <div className="absolute inset-0">
                        {[...Array(20)].map((_, i) => (
                            <div
                                key={i}
                                className={`absolute w-1 h-1 ${isDark ? "bg-green-500/30" : "bg-green-600/20"
                                    } rounded-full`}
                                style={{
            ...
            <button
                ...
                className={`fixed top-3 right-3 z-50 p-3 rounded-full ${isDark
            ...
            <div className="flex flex-col lg:flex-row relative z-10">
                <div
                    className={`lg:fixed lg:left-0 lg:top-0 lg:h-screen ${isDark ? "bg-zinc-900/80" : "bg-white/80"
                        } lg:w-80 p-6 lg:overflow-y-auto backdrop-blur-sm border-r ${isDark ? "border-zinc-800" : "border-gray-200"
                        }`}
                >
                        ...
                        {socials.map((social, i) => (
                            <button
                                ...
                                className={`w-10 h-10 ${isDark
                                    ? "bg-zinc-800/50 hover:bg-zinc-700/50"
                                    : "bg-gray-200/50 hover:bg-gray-300/50"
                                    } rounded-lg flex items-center justify-center transition-colors backdrop-blur-sm hover:scale-110`}
                            >
                ...
                <div className="lg:ml-80 flex-1 p-6 lg:p-12">
                    <div className="mb-12">
                        ...
                        <p
                            className={`${isDark ? "text-gray-400" : "text-gray-600"
                                } max-w-2xl mb-8 backdrop-blur-sm p-4 rounded-xl ${isDark ? "bg-black/30" : "bg-white/30"
                                }`}
                        >
                        ...
                        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
                            {stats.map((stat, i) => (
                                <div
                                    key={i}
                                    className={` p-5 rounded-xl text-center backdrop-blur-sm hover:scale-105 transition-transform duration-300 ${isDark
                                        ? "bg-zinc-900/50 hover:bg-zinc-800/50"
                                        : "bg-white/50 hover:bg-gray-200/50"
                                        }`}
                                >
                    ...
                    <section className="mb-12">
                        ...
                        <div className="space-y-4">
                            {jobs.map((job, i) => (
                                <div
                                    key={i}
                                    className={`${isDark ? "bg-zinc-900/50" : "bg-white/50"
                    ...
                    <section className="mb-12">
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                            {visibleProjects.map((project, i) => (
                                <a href={project.path} target="_blank" key={i}>
                                    <div
                                        className={`${isDark ? "bg-zinc-900/50" : "bg-white/50"
                                            } rounded-xl overflow-hidden group cursor-pointer backdrop-blur-sm hover:scale-[1.02] transition-transform duration-300 relative`}
                                    >
                                        <div
                                            className={`${project.color
                                                } h-[250px] flex items-center justify-center text-4xl font-bold ${project.color.includes("green") ||
                                        ...
                                        >
                                            ...
                                            <img
                                                ...
                                                src={project.image}
                                                alt={project.name}
                                                className={`w-${project.name === "Homixstore" ? "[350px]" : "[340px]"
                                        ...
                                        <div
                                            className={`absolute inset-0 ${isDark ? "bg-black/90" : "bg-white/95"
                                                } backdrop-blur-sm flex flex-col items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-300 z-20 rounded-xl`}
                                        >
                                            <div className="text-center p-6">
                                                ...
                                                <div className="flex flex-wrap justify-center gap-4 mb-6">
                                                    {project.stack.map((tech, index) => (
                                                        ...
                                                        >
                                                            <span
                                                                className={`inline-block text-2xl transition-all duration-300 hover:scale-110 ${tech.color
                                                                    ? `bg-gradient-to-br ${tech.color} text-white p-2 rounded-xl`
                                                                    : isDark
                                                                        ? "text-gray-300"
                                                                        : "text-gray-700"
                                                                    }`}
                                                            ...
                                                            <span
                                                                className={`text-xs mt-2 font-medium ${isDark ? "text-gray-300" : "text-gray-700"
                                                                    }`}
                                                            >
                                                                {tech.name || tech}
                                                            </span>
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                            {WhatIDo.map((item, index) => {
                                ...
                                return (
                                    <div
                                        key={index}
                                        className={`flex items-start gap-4 p-5 ${isDark
                                            ? "bg-zinc-900/50 text-white"
                                            : "bg-white/50 text-black"
                                            } rounded-xl backdrop-blur-sm border ${isDark ? "border-zinc-800" : "border-gray-200"
                                            } hover:border-green-500  transition-all duration-300`}
                                    >
                                        <div
                                            className={`p-3 ${isDark ? "bg-zinc-800/50" : "bg-gray-100/50"
                        ...
                        <div className="grid grid-cols-2 lg:grid-cols-3 gap-4">
                            {skills.map((skill, i) => (
                                <div
                                    key={i}
                                    className={`${isDark ? "bg-zinc-900/50" : "bg-white/50"
                                        } p-4 rounded-xl flex items-center gap-3 backdrop-blur-sm hover:scale-105 transition-transform duration-300 cursor-pointer`}
                                >
                                    <div
                    ...
                    <section
                        className={`${isDark ? "bg-zinc-900/50" : "bg-white/50"
                            } p-8 rounded-2xl backdrop-blur-sm border ${isDark ? "border-zinc-800" : "border-gray-200"
                            }`}
                    >
                        <h2 className="text-2xl font-bold mb-6 flex items-center gap-2">
                            <img
                            ...
                            <div className="space-y-4">
                                ...
                                <form onSubmit={handleSubmit}>
                                    <input
                                        ...
                                        className={`w-full ${isDark ? "bg-black/30" : "bg-gray-100/50"
                                            } px-4 py-3 mb-2 rounded-xl outline-none backdrop-blur-sm border ${isDark ? "border-zinc-800" : "border-gray-200"
                                    ...
                                    <textarea
                                        ...
                                        rows="4"
                                        className={`w-full ${isDark ? "bg-black/30" : "bg-gray-100/50"
                                            } px-4 py-3 mb-2 rounded-xl outline-none resize-none backdrop-blur-sm border ${isDark ? "border-zinc-800" : "border-gray-200"
                                            } focus:border-green-500 focus:ring-2 focus:ring-green-500/20 transition-all`}
                                        required
                                    ></textarea>
                                    <ValidationError
                    ...
                    <footer
                        className={`mt-12 text-center text-md text-gray-400 p-8 rounded-2xl backdrop-blur-sm border ${isDark
                            ? "bg-zinc-900/50 border-zinc-800"
                            : "bg-gray-100/50 border-gray-200"
                            }`}
                    >
                        <p className="inline-flex items-center justify-center animate-pulse">
                            Created by zakaryae rouane{" "}
                            <IoMdCheckmarkCircleOutline size={18} className="text-green-500 ml-1" />
                        </p>
                    </footer>
                </div>
            </div>
            {showPDF && (
                <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-[999] p-4 animate-fadeIn">
                    <div
                        className={`w-full max-w-3xl ${isDark ? "bg-zinc-900/80" : "bg-white/80"
                            } rounded-2xl p-5 shadow-xl backdrop-blur-sm border ${isDark ? "border-zinc-800" : "border-gray-200"
                            }`}
                    >
